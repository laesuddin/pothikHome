    ...
    <div>
      ...
      <section className="mt-12 mb-16 bg-[#fff]">
        <div className="px-24">
          ...
          <div className="my-4">
            <button className="accordion text-xl font-bold uppercase">
              Kuakata
            </button>
            ...
            <div className="panel uppercase text-xl">
              ...
              <div className="flex gap-12 justify-between items-center my-4 gap-6">
                ...
                <div
                  className="flex bg-[#D9D9D9] w-[40%] h-[680px] justify-between shrink-0 p-8"
                >

                  <div className="grid grid-cols-2 gap-6 text-gray-800">
                    <div
                      className="bg-[#7ECC71] px-4 py-2 flex justify-center items-center"
                    >
                      A1
                    </div>
                    <div
                    ...
                    <div
                      className="bg-[#F3BCBC] px-4 py-2 flex justify-center items-center"
                    >
                      G1
                    </div>
                    <div
              ...
              <div className="my-12 text-md">
                ...
                <button className="btn bg-green-500 px-8 py-1 uppercase rounded-sm">
                  Optimize Seat
                </button>
              </div>
            </div>
