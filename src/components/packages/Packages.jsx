  ...
  return (
    ...
    <div className="flex gap-x-8">
      <div className="w-1/3 shadow-lg">
        ...
        <div>
          <div className="flex justify-between mx-3">
            <h2 className="text-[#2ED89B] text-2xl font-semibold">BANDORBAN</h2>
            <p><strong className="text-[#19A361] text-2xl">2500tk</strong></p>
          </div>
      ...
      <div className="w-1/3 shadow-lg">
        ...
        <div>
          <div className="flex justify-between mx-3">
            <h2 className="text-[#2ED89B] text-2xl font-semibold">KUAKATA</h2>
            <p><strong className="text-[#19A361] text-2xl">2500tk</strong></p>
          </div>
          <div className="my-4 flex text-[#2D5527] gap-x-4 mx-1">
            <div className="flex flex-col justify-center items-center">
